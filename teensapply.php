...
$highschool = $_POST['hs'];
$grade = $_POST['grade'];
$interests=$_POST['flexCheckDefault'];


if (isset($_POST['submit'])) {
    $stmt = $database->prepare("INSERT INTO teensapply (firstname, surname, address, cellphone, highschool, grade, interests) 
			VALUES (?, ? ,?, ?, ?, ? , ?)");
    $stmt->bind_param('sssssss', $firstname, $surname, $address, $cellphone, $highschool, $grade, $interests);
    $stmt->execute();           
    $error = "success"; 
            ...
            <section class="row justify-content-center">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="cellphone" id="cellphone" type="number" class="form-control" placeholder="Your Cell Phone" required>
                    </div>
                    <div class="form-group">
                        <label for="inputHighSchool">Your High School</label>
                        <input id="hs" type="text"  name="hs" class="form-control" placeholder="Your High School" required>
                    </div>
                    <div class="form-group">
                        <label for="inputGrade">Your Grade</label>
                        <input name="grade" id="grade" type="number"  class="form-control" placeholder="Your Grade" required>
                    </div>
                    <h4>Interests:</h4>
                    <div name="flexCheckDefault" class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Painting" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" value="Painting"  for="flexCheckDefault">
                            Painting
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Yard Work" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" for="flexCheckDefault">
                            Yard Work
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Pet Care" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" name="flexCheckDefault" for="flexCheckDefault">
                            Pet Care
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Clerical Work" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" for="flexCheckDefault">
                            Clerical Work
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Organisational tasks" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" for="flexCheckDefault">
                            Organisational tasks
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="flexCheckDefault" type="radio" value="Moving Furniture" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" for="flexCheckDefault">
                            Moving Furniture
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input"  name="flexCheckDefault" type="radio" value="Cleaning" id="flexCheckDefault">
                        <label class="form-check-label" name="flexCheckDefault" for="flexCheckDefault">
                            Cleaning
                        </label>
                    </div>

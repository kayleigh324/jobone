...
if (isset($_POST['submit'])) {
    $stmt = $database->prepare("INSERT INTO login (username, password, fullname) 
			VALUES (?, ?, ?)");
        ...
        <form method="POST">
            ...
            <div class="form-col align-items-center center">
                   <div class="col-auto my-1 form">
                    <label for="exampleDropdownFullname">Full name</label>
                    <input name="fullname" type="text" id="fullname"  class="form-control" placeholder="Your Full Name" required>
                </div>
                <div class="col-auto my-1 form">
